...
function AudioPlayer(options) {
  ...
  this.width = options.width === undefined ? 470 : options.width;
  this.height = 25;
  ...
  this.hlColour = options.hlColour === undefined ? "#0038ba" : options.hlColour;
...
AudioPlayer.prototype._drawLoadingAnimation = function () {
  ...
  for(var i = 0; i < 8; i++) {
    var heightOffset = Math.sin(this._loadDeltaTime + i) * 10;
    this._drawingContext.beginPath();
    this._drawingContext.arc((this.width/2) - (i * 10) + 30, (this.height/2) + heightOffset, 3, 0, 360);
